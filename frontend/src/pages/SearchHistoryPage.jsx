		...
		const getSearchHistory = async () => {
		  try {
			...
			if (res.data && res.data.content) {
			  setSearchHistory(res.data.content);
			  console.log("Search History:", res.data.content);  // Log the content if available
			} else {
			  console.log("No search history found in the response.");
			  setSearchHistory([]);  // Set empty array if no content exists
			}
		  } catch (error) {
			console.error("Error fetching search history:", error);
			setSearchHistory([]);  // Handle error and set empty array
		  }
		};
