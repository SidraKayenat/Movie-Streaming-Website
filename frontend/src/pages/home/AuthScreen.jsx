    ...
    return (
        <div className='hero-bg relative'>
            ...
            <div className='flex flex-col items-center justify-center  text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <h1 className='text-lg mb-4'>Watch anywhere. Cancel anytime</h1>
                <h1 className='mb-4'>Ready to watch? Enter your email to create or restart your membership</h1>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative'>
                        ...
                        <video className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-0' playsInline autoPlay={true} muted loop>
